...
This is an introduction for beginners having the community of `r/streamentry` about the essential guideline for working towards stream entry, that in my humble opinion reflect what I have interpreted from learning HH material, specially the two last books of Ajahn Nyanamoli.
...
> — "It can be like that, *[ non celibacy is not obtrusive for the one who is non celibacy ... ]*"
> 
...
0. as regards sammādiṭṭhi; the only way to find something is to keep seeking for it until one finds it.
1. as regards training oneself; to know one is delusional and needs to be constantly vigilant to step by step walk the dhammapada
2. as regards bodily actions; to treat any other better than one would treat oneself.
