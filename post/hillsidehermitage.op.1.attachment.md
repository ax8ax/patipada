...
`[ 1 ]` The post is explained using the smile of a `video_game`, a `roleplay_game`. I think some people would greatly benefit if they try to role\_play all\_day to act as buddha himself would act in a vr-chat universe. Larp as a buddha, until you succeed to be like one. This will make you happy.
...
## `■■` similes — the eight limb search for the root of thirst
